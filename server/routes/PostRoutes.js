...
import {
  ...
  getCommentsByPostId,
  toggleCommentLike,
} from "../controllers/post-controller/PostCommentController.js";
...
postRouter.patch(`/user/post/private/:post_id`, togglePostPrivate);
postRouter.patch(`/user/post/update/status`, updatePostStatus);
postRouter.patch(
  "/user/edit/post/:objectId",
  postUpload,
  processImage,
  editPost,
);
postRouter.post("/user/task/submission/post", PostByUserTaskSubmission);
