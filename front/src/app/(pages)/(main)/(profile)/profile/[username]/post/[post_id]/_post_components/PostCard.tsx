...
import { formatDate, getErrorResponse, getUserAvatar } from '@/contexts/Callbacks';
        ...
        <div>
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="p-4 flex items-center gap-3 border-b border-gray-50">
                    <img src={getUserAvatar(user?.avatar || [])} className="w-10 h-10 rounded-full" alt="User" />
                ...
                <div className="p-4">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-100 text-sm text-gray-500">
                        ...
                        >
                            {isLiked ? (
                                <FaThumbsUp size={18} className="scale-110 transition-transform" />
                            ) : (
                                <BiLike size={18} className="group-hover:scale-110 transition-transform" />
                            )}
