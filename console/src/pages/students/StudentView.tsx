    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden top-6 relative group">
            <a
              href={frontendUrl}
              target="_blank"
              rel="noreferrer"
            ...
            <div className="px-6 pb-8 text-center relative">
              ...
              {/* Username Link as well for accessibility */}
              <a
                href={frontendUrl}
                target="_blank"
                rel="noreferrer"
                className="text-sm text-gray-500 mb-4 hover:text-purple-600 hover:underline inline-block transition-colors"
              >
