...
export default function EditCategory() {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      parent_category:
        allCategory?.find(
          (item) =>
            item?.parent_category === categoryData?.parent_category &&
            item?.category_name === categoryData?.parent_category,
        )?._id || "",
  ...
  if (loading) return <>Edit categoryLoading</>;
  return (
      ...
      <Breadcrumbs
        ...
        breadcrumbs={[
          ...
          { label: "Category", path: "/dashboard/category" },
          {
            ...
            path: `/dashboard/category/${categoryData?._id}`,
          },
          { label: "Edit" },
        ]}
      />
