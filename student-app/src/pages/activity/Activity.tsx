...
import Posts from "./post_compoents/Posts";
    ...
    <div>
      ...
      <div className="grid-cols-1 md:grid-cols-3 grid gap-6">
        <div className="md:col-span-2 space-y-6">
          {/* --- Create Post Widget --- */}
          <div
            className={`bg-white rounded-xl border transition-all duration-200 ${showNewPostForm ? "border-gray-200 shadow-md ring-1 ring-gray-100" : "border-gray-200 shadow-sm"}`}
          >
            {!showNewPostForm ? (
              // Collapsed View
              <div className="p-4 flex items-center gap-3">
                ...
                <label
                  className="p-2.5 text-gray-500 hover:bg-gray-100 hover:text-blue-600 rounded-full cursor-pointer transition-colors"
                  title="Upload Media"
                >
                  <BiImageAdd size={24} />
                  <input
              ...
              <div className="p-4 animate-in fade-in slide-in-from-top-1 duration-200">
                ...
                <textarea
                  ...
                  className="w-full p-0 border-none resize-none focus:ring-0 outline-none text-base placeholder-gray-400 min-h-30 text-gray-800 leading-relaxed"
                  autoFocus
                />
                ...
                {previews.length > 0 && (
                  <div className="mt-3 mb-2 overflow-x-auto pb-2 flex gap-2 no-scrollbar">
                    {previews.map((src, idx) => (
                      <div
                        key={idx}
                        className="relative group shrink-0 w-32 h-32"
                      >
                        <img
                          src={src}
                          alt={`Preview ${idx}`}
